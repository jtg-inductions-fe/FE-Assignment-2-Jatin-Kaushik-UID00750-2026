 ...
 * @param props.categorizedData - Array of menu categories with their associated items.
 * @param props.renderItemCard - Render prop function used to instantiate custom item cards.
 */
